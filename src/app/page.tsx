...
export default function Home() {
  return (
    <div className="flex relative    flex-row  justify-between gap-20 items-start content-center   max-lg:flex-col max-lg:items-center ">
      <div className=" relative lg:sticky top-4 max-lg:justify-start max-w-[320px] max-h-[500px]  py-20  justify-center items-center flex">
        <Posts />
      </div>

      <div className=" flex flex-col gap-5 h-full no-scrollbar  min-w-[720px] py-4 ">
        <div className="  flex gap-[20px] ">
          <BentoCard
            className=" animate-in fill-mode-both fade-in slide-in-from-bottom-11  duration-500 delay-700  sticky top-4"
            type="large"
            border="none"
          >
          ...
          <div className="flex flex-col gap-[20px]">
            <div className="flex gap-[20px]">
              <BentoCard
                type="small"
                className="animate-in fade-in slide-in-from-bottom-11 fill-mode-both  duration-1000 delay-800  flex flex-col"
              >
                <div
                  style={{
                    width: "fit-content",
            ...
            <BentoCard type="medium">
              <div className="flex h-full justify-between">
                ...
                <BentoImage src="/og.jpeg" alt="Profile Image" type="small" />
              </div>
            </BentoCard>
          </div>
        </div>

        <Link href={"#projects"} className="mt-10 font-semibold text-2xl">
          <span className="font-sm text-neutral-500">{"##  "}</span>
          Project Showcase
        </Link>
